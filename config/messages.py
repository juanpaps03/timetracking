...
NO_BUILDING = _('No tienes una obra asociada. Consultar con administración.')
INPUT_DHT_GENERAL_ERROR = _('Falta indicar fecha final de la primera quincena.')
UTE_OSE_EMPTY = _('Todos los valores son vacíos.')
UTE_OSE_EMPTY_UPDATE_OK = _('Valores de UTE y OSE actualizados correctamente.')
